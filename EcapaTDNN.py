...
from Attack.hook import LayerActivations
...
class EcapaTDNN_SpeakerIdetification(nn.Module):
    def __init__(self, backbone, num_class=1, lin_blocks=0,lin_neurons=192, dropout=0.1):
        super(EcapaTDNN_SpeakerIdetification, self).__init__()
