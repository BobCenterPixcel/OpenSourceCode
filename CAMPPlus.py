...
class CAMPPlus(nn.Module):
    def __init__(self,
        ...
        self.xvector = nn.Sequential(
            # channels -> 1216
            OrderedDict([('tdnn', TDNNLayer(1216,
                                            init_channels,
                                            5,
                                            stride=2,
                                            dilation=1,
...
class CAMPPlus_SpeakerIdetification(nn.Module):
    def __init__(
            self,
            backbone,
            num_class=1,
            ...
            lin_neurons=192,
            dropout=0.1, ):
        super(CAMPPlus_SpeakerIdetification, self).__init__()
        self.backbone = backbone
        if dropout > 0:
            self.dropout = nn.Dropout(dropout)
        else:
            self.dropout = None
        input_size = self.backbone.embd_dim
